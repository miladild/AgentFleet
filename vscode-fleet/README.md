...
While the plan is worked out it shows the files and searches the strongest
machine goes through; then the plan, with approve and reject; then the run: the
steps as a pipeline, the machine on each, and a log of what they do, updated
